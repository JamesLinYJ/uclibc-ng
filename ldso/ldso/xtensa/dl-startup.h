...
__asm__ (
    ...
    "	.align  4\n"
    "   .literal_position\n"
    ".Lfdpic_rofixup_list_delta:\n"
    "	.word	__ROFIXUP_LIST__@pcrel\n"
    ".Lfdpic_rofixup_list_adjust:\n"
    "	.word	.Lfdpic_rofixup_list_delta - .Lfdpic_bootstrap_pc\n"
    ".Lfdpic_rofixup_end_delta:\n"
    "	.word	__ROFIXUP_END__@pcrel\n"
    ".Lfdpic_rofixup_end_adjust:\n"
    "	.word	.Lfdpic_rofixup_end_delta - .Lfdpic_bootstrap_pc\n"
    "	.global _start\n"
    ...
    /* Map the read-only fixup table through the interpreter loadmap.
       Falling back to the executable map keeps standalone ld.so useful. */
    "	mov	a2, a15\n"
    "	l32r	a3, .Lfdpic_rofixup_list_delta\n"
    "	l32r	a10, .Lfdpic_rofixup_list_adjust\n"
    "	add	a3, a3, a10\n"
    "	mov	a4, a13\n"
    "	bnez	a4, .Lfdpic_map_list\n"
    "	mov	a4, a12\n"
    ".Lfdpic_map_list:\n"
    ...
    /* Translate a link-time delta from a known runtime PC through a
       validated FDPIC loadmap.  Unlike a single load bias, this works when
    ...
    "	l32i	a9, a7, 8\n"
    "	sub	a10, a2, a8\n"
    "	bltu	a10, a9, .Lfdpic_runtime_found\n"
    "	addi	a7, a7, 12\n"
    "	addi	a6, a6, -1\n"
    "	bnez	a6, .Lfdpic_find_runtime\n"
    "	j	.Lfdpic_map_fail\n"
    ".Lfdpic_runtime_found:\n"
    "	l32i	a8, a7, 4\n"
    "	add	a3, a3, a8\n"
    "	add	a3, a3, a10\n"
    "	mov	a6, a5\n"
    ...
    "	l32i	a9, a7, 8\n"
    "	sub	a10, a3, a8\n"
    "	bltu	a10, a9, .Lfdpic_link_found\n"
    "	bne	a10, a9, .Lfdpic_link_next\n"
    "	beqi	a6, 1, .Lfdpic_link_found\n"
    ".Lfdpic_link_next:\n"
    "	addi	a7, a7, 12\n"
    "	addi	a6, a6, -1\n"
    "	bnez	a6, .Lfdpic_find_link\n"
    ".Lfdpic_map_fail:\n"
    "	movi	a2, -1\n"
    "	ret\n"
    ".Lfdpic_link_found:\n"
    ...
    "	add	a2, a2, a10\n"
    "	ret\n"
    ".Lfdpic_bootstrap_fail:\n"
    "	ill\n"
    "	j	.Lfdpic_bootstrap_fail\n"
#else
